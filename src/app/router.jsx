...
import MyPage from '../domains/my/pages/MyPage';
import PasswordChange from '../domains/my/pages/PasswordChange';
import EmailLogin from '../domains/auth/pages/EmailLogin';
import SignUp from '../domains/auth/pages/SignUp';
import GetLocation1 from '../domains/auth/pages/GetLocation1';
import DeleteAccount from '../domains/my/pages/DeleteAccount';
import ProductManage from '../domains/my/pages/ProductManage';
import DeleteAccountComplete from '../domains/my/pages/DeleteAccountComplete';
import ChangeAddress from '../domains/my/pages/ChangeAddress';
import AccountSettings from '../domains/my/pages/AccountSettings';
import InformationEdit from '../domains/my/pages/InformationEdit';
