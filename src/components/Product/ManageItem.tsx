...
export default function ManageItem({ image, name, dateStart, dateEnd, price, state, onClick, onEdit }: Props) {
    return (
        <div className={styles.item} onClick={onClick}>
            ...
            <div className={styles.content}>
                <div className={styles.info}>
                    ...
                    <p className={styles.period}>{formatDate(dateStart)} ~ {formatDate(dateEnd)}</p>
                </div>
