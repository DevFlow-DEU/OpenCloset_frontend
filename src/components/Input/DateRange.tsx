...
export default function DateRange({ label, placeholder = "날짜를 선택하세요", value, onChange, error }: Props) {
        ...
        <div className={styles.wrapper}>
            ...
            <Popover.Root>
                <Popover.Trigger asChild>
                    <button type="button" className={`${commonStyles.inputField} ${styles.trigger}`}>
                ...
                <Popover.Portal>
                    <Popover.Content className={styles.popoverContent} align="start" sideOffset={4}>
                        <DayPicker
                            mode="range"
