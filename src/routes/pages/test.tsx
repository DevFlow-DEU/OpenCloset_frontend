...
const MANAGE_ITEMS: { id: number; image: string; name: string; dateStart: string; dateEnd: string; price: number; state: StateType }[] = [
    { id: 1, image: "https://picsum.photos/seed/p1/100", name: "MH GRAPHIC SHORT SLEEVE_32YA6B50", dateStart: "2024-12-23", dateEnd: "2024-12-31", price: 3200, state: "대여중" },
    { id: 2, image: "https://picsum.photos/seed/p2/100", name: "나이키 에어맥스 270", dateStart: "2025-01-05", dateEnd: "2025-01-10", price: 5000, state: "예약중" },
    { id: 3, image: "https://picsum.photos/seed/p3/100", name: "빈폴 체크 울 코트 겨울 시즌 한정판", dateStart: "2024-12-01", dateEnd: "2024-12-15", price: 8000, state: "대여완료" },
]

const CHAT_ITEMS = [
    { id: 1, itemImage: "https://picsum.photos/seed/a/56", userImage: "https://picsum.photos/seed/u1/40", name: "김민준", message: "내일 오후 2시에 거래 가능하신가요?", time: "오후 2:30", unread: 3 },
    { id: 2, itemImage: "https://picsum.photos/seed/b/56", userImage: "https://picsum.photos/seed/u2/40", name: "이서연", message: "네 감사합니다!", time: "오전 11:15", unread: 0 },
    { id: 3, itemImage: "https://picsum.photos/seed/c/56", userImage: "https://picsum.photos/seed/u3/40", name: "박도윤", message: "혹시 사이즈 조절 가능한가요?", time: "어제", unread: 12 },
    { id: 4, itemImage: "https://picsum.photos/seed/d/56", userImage: "https://picsum.photos/seed/u4/40", name: "최지아", message: "확인했습니다 ㅎㅎ", time: "월요일", unread: 1 },
    { id: 5, itemImage: "https://picsum.photos/seed/e/56", userImage: "https://picsum.photos/seed/u5/40", name: "정하은", message: "대여 기간 연장 부탁드려도 될까요?", time: "5/20", unread: 0 },
]

const EMPTY_FILTER: FilterValue = {
    gender: "", priceMin: "", priceMax: "", category: "", sizes: [], dateStart: "", dateEnd: ""
}
